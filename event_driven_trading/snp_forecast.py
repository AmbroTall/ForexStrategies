...
from machine_learning_models import create_lagged_series
...
class SPYDailyForecastStrategy(Strategy):
    ...
    def __init__(self, bars, events):
        """
        Initializes the SPYDailyForecastStrategy.
    ...
    def create_symbol_forecast_model(self):
        """
        Create a forecast model using Quadratic Discriminant Analysis.
    ...
    def calculate_signals(self, event):
        ...
        if event.type == 'MARKET':
            ...
            if self.bar_index > 5:
                lags = self.bars.get_latest_bars_values(sym, "returns", N=3)
